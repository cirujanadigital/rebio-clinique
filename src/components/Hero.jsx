...
export default function Hero() {
  return (
    <header id="hero" role="banner">
      <img
        src={`${import.meta.env.BASE_URL}img/hero-clinica.webp`}
      ...
      <div className="hero-content">
        ...
        <div className="hero-stats-sidebar" role="group" aria-label="Métricas clínicas">
